...
function pakmo(){
    return(
        ...
        <div className='kotak1'>
            <div className='gbr_mojokerto'>
                <img src={'https://pakmo.mojokertokota.go.id/img/banner.47566421.png'} />
            </div>
            <nav>
                <div className='gbr_pakmo_gercep'>
                    <img  src={'https://pakmo.mojokertokota.go.id/img/brand-3.82ef0180.svg'} />
                </div>
            ...
            <div className='kotak3'>
                ...
                <div className='kotak_teks_terwujud'>
                    <p className='teks_terwujud'>“Terwujudnya Kota Mojokerto yang Berdaya Saing, Mandiri, Demokratis, Adil Makmur, Sejahtera, dan Bermartabat”</p>
                    <p className='teks_visi'>VISI</p>
                    <p className='teks_visi'>Kota Mojokerto</p>
                </div>
                <div className='kotak_teks_walkot'>
                    <p className='teks_nama_walkot'>Hj. Ika Puspitasari, SE</p>
                    <p className='teks_jabatan'>Walikota Mojokerto</p>
                </div>
            </div>
        </div>
